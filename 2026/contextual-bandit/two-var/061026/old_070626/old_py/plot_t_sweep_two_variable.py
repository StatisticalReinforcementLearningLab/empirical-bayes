...
def main():
    ...
    #     2, 1,
    #     figsize=(8.5, 9.5),
    #     gridspec_kw={'height_ratios': [3.1, 2.4]}
    # )
    ...
    params_line2 = rf"$\bm{{\Sigma}}_0={format_mat3(Sigma_a[0])}$"
    params_line3 = rf"$\bm{{\Sigma}}_1={format_mat3(Sigma_a[1])}$"
    ...
    fig.text(0.5, 0.160, params_line1, fontsize=8.5, va='bottom', ha='center')
    fig.text(0.5, 0.122, params_line2, fontsize=8.0, va='bottom', ha='center')
    fig.text(0.5, 0.086, params_line3, fontsize=8.0, va='bottom', ha='center')
    fig.text(0.5, 0.052, params_line4, fontsize=8.5, va='bottom', ha='center')
    fig.text(0.5, 0.026, params_line5, fontsize=8.5, va='bottom', ha='center')

    plt.tight_layout(rect=[0, 0.20, 1.0, 0.97])
