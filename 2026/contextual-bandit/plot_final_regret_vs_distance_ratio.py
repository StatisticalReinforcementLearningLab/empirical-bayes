...
def main():
    ...
    df_p02 = pd.read_csv("final_regret_vs_distance_ratio_p02.csv")
    df_p05 = pd.read_csv("final_regret_vs_distance_ratio_p05.csv")
    ...
    fig.suptitle(r"Algorithm Performance vs. Distance Ratio", y=0.9, fontsize=18)
    ...
    out_path = "plots/final_regret_vs_distance_ratio.png"
